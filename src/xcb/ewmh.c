...
unsigned short initialize_ewmh() {
    ...
    unsigned int events = XCB_EVENT_MASK_POINTER_MOTION;
    ...
    xcb_ewmh_set_wm_name(ewmh_connection, ewmh_window, 5, "prism");
...
void finalize_ewmh() {
    ...
    xcb_destroy_window(xcb_connection, ewmh_window);
